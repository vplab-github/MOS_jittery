function [BPLR, desc] = demoBPLR(folder,img_file, rsz, order_k, euc_f, min_nseg, max_nseg, grid_space, min_elem_scale, magnif, phog_L, n_angle_bin, n_length_bin)
...
img_file_rsz = [img_path '/bplr/' img_name '_rsz_' num2str(rsz) img_ext];
imwrite(im, img_file_rsz);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Pre-processing: Berkeley segmentation
img_file1=[img_path '/bplr/' img_name]
% 1. compute globalPb
gpb_out_file = [img_file1 '_gPb_rsz_' num2str(rsz) ' .mat'];
...
ucm_out_file = [img_file1 '_ucm_rsz_' num2str(rsz) '.mat'];
